...
const LessonTakeawaysContent: React.FC<LessonTakeawaysContentProps> = ({ lesson }) => {
  ...
  return (
    <div className="space-y-3 sm:space-y-5 animate-fade-in w-full max-w-full break-words overflow-x-visible">
      {lesson.keyTakeaways && (
        <div className="bg-green-50 border border-green-100 rounded-lg p-3 sm:p-4 animate-slide-up hover-lift w-full max-w-full break-words overflow-x-visible">
          ...
          <div className="text-green-700 text-sm prose prose-sm max-w-none w-full break-words overflow-x-visible">
      ...
      {lesson.reflectionPrompts && (
        <div className="bg-amber-50 border border-amber-100 rounded-lg p-3 sm:p-4 animate-slide-up hover-lift w-full max-w-full break-words overflow-x-visible">
          <h2 className="font-semibold text-amber-800 mb-2 text-sm md:text-base">
            {language === 'en' ? 'Reflect & Grow' : 'ပြန်လည်သုံးသပ်ပြီး တိုးတက်ပါ'}
          </h2>
          <div className="text-amber-700 text-sm prose prose-sm max-w-none w-full break-words overflow-x-visible">
