...
const LessonDetail = () => {
  ...
  return (
    <div>
      ...
      {/* Navigation Tabs - Fixed below header (Mobile specific) */}
      <LessonNavigation 
      ...
      {/* Main Content Area */}
      <div 
        className="pt-[104px] h-[calc(100vh-104px-64px)] overflow-y-auto md:h-auto md:overflow-visible px-4 pb-6 md:pt-6 md:pb-0"
