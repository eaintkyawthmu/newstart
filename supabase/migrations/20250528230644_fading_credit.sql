...
DROP CONSTRAINT IF EXISTS course_progress_user_id_lesson_id_key;

ALTER TABLE course_progress 
DROP CONSTRAINT IF EXISTS course_progress_user_id_course_id_module_id_key;

-- Then add the lesson_id column if it doesn't exist
DO $$ 
BEGIN
  IF NOT EXISTS (
